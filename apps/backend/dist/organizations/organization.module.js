...
exports.OrganizationsModule = OrganizationsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [organization_controller_1.OrganizationsController],
        providers: [organization_service_1.OrganizationsService],
        exports: [organization_service_1.OrganizationsService]
    })
], OrganizationsModule);
